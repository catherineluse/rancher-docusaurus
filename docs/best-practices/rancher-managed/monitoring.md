...
You can find more information on how to set up alerts and notification channels in the [Rancher Documentation](https://rancher.com/docs/rancher/v2.6/en/monitoring-alerting).