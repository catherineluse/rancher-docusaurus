...
After [setting up istio](https://rancher.com/docs/rancher/v2.6/en/istio/setup) you can leverage Istio's control plane functionality through the Rancher UI, `kubectl`, or `istioctl`.
...
Before enabling Istio, we recommend that you confirm that your Rancher worker nodes have enough [CPU and memory](https://rancher.com/docs/rancher/v2.6/en/istio/resources) to run all of the components of Istio.
...
Refer to the [setup guide](https://rancher.com/docs/rancher/v2.6/en/istio/setup) for instructions on how to set up Istio and use it in a project.

# Remove Istio

To remove Istio components from a cluster, namespace, or workload, refer to the section on [uninstalling Istio.](https://rancher.com/docs/rancher/v2.6/en/istio/disabling-istio/)
...
``` 
 Additional Istio Ingress gateways can be enabled via the [overlay file](https://rancher.com/docs/rancher/v2.6/en/istio/configuration-reference/#overlay-file).

### Egress Support

By default the Egress gateway is disabled, but can be enabled on install or upgrade through the values.yaml or via the [overlay file](https://rancher.com/docs/rancher/v2.6/en/istio/configuration-reference/#overlay-file).

# Additional Steps for Installing Istio on an RKE2 Cluster

To install Istio on an RKE2 cluster, follow the steps in [this section.](https://rancher.com/docs/rancher/v2.6/en/istio/configuration-reference/rke2/)
