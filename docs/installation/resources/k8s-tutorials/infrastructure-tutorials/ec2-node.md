...
1. In **Step 6: Configure Security Group,** select a security group that complies with the [port requirements](https://rancher.com/docs/rancher/v2.6/en/installation/requirements/#port-requirements) for Rancher nodes.
