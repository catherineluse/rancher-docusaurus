...
This section describes how to use `firewalld` to apply the [firewall port rules](https://rancher.com/docs/rancher/v2.6/en/installation/requirements/ports) for nodes in a high-availability Rancher server cluster.
