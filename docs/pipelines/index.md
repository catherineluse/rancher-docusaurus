...
For an explanation of concepts and terminology used in this section, refer to [this page.](https://rancher.com/docs/rancher/v2.6/en/pipelines/concepts)
...
Before pipelines can be configured, you will need to configure authentication to your version control provider, e.g. GitHub, GitLab, Bitbucket. If you haven't configured a version control provider, you can always use [Rancher's example repositories](https://rancher.com/docs/rancher/v2.6/en/pipelines/example-repos/) to view some common pipeline deployments.
...
When you configure a pipeline in one of your projects, a namespace specifically for the pipeline is automatically created. The following components are deployed to it:
  ...
  \>**Note:** The managed Jenkins instance works statelessly, so don't worry about its data persistency. The Docker Registry and Minio instances use ephemeral volumes by default, which is fine for most use cases. If you want to make sure pipeline logs can survive node failures, you can configure persistent volumes for them, as described in [data persistency for pipeline components](https://rancher.com/docs/rancher/v2.6/en/pipelines/storage).
...
Only [administrators](https://rancher.com/docs/rancher/v2.6/en/admin-settings/rbac/global-permissions/), [cluster owners or members](https://rancher.com/docs/rancher/v2.6/en/admin-settings/rbac/cluster-project-roles/#cluster-roles), or [project owners](https://rancher.com/docs/rancher/v2.6/en/admin-settings/rbac/cluster-project-roles/#project-roles) can configure version control providers and manage global pipeline execution settings.
...
Refer to [this page](https://rancher.com/docs/rancher/v2.6/en/pipelines/config) for details on how to configure a pipeline to:
...
\> **Note:** This option doesn't exist for Rancher's [example repositories](https://rancher.com/docs/rancher/v2.6/en/pipelines/example-repos/).
