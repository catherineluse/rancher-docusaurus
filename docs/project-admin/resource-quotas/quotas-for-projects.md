...
![Native Kubernetes Resource Quota Implementation](./assets/img/rancher/kubernetes-resource-quota.svg)
...
![Rancher Resource Quota Implementation](./assets/img/rancher/rancher-resource-quota.png)
