...
| Cloud Credentials | Select the cloud credentials that you created for your IAM policy. For more information on creating cloud credentials in Rancher, refer to [this page.](https://rancher.com/docs/rancher/v2.x/en/user-settings/cloud-credentials/) |
