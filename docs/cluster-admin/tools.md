...
For more information, refer to the logging documentation [here.](https://rancher.com/docs/rancher/v2.6/en/logging/)
...
For more information, refer to the monitoring documentation [here.](https://rancher.com/docs/rancher/v2.6/en/monitoring-alerting/)
...
For more information, refer to the Istio documentation [here.](https://rancher.com/docs/rancher/v2.6/en/istio)
# OPA Gatekeeper

[OPA Gatekeeper](https://github.com/open-policy-agent/gatekeeper) is an open-source project that provides integration between OPA and Kubernetes to provide policy control via admission controller webhooks. For details on how to enable Gatekeeper in Rancher, refer to the [OPA Gatekeeper section.](https://rancher.com/docs/rancher/v2.6/en/opa-gatekeper)

# CIS Scans

Rancher can run a security scan to check whether Kubernetes is deployed according to security best practices as defined in the CIS Kubernetes Benchmark.

For more information, refer to the CIS scan documentation [here.](https://rancher.com/docs/rancher/v2.6/en/cis-scans)