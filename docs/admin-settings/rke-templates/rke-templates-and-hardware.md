...
When you create a [CIS benchmark compliant cluster,](https://rancher.com/docs/rancher/v2.6/en/security/) you have an encryption config file and an audit log config file.
