...
For more detail about evaluating a hardened cluster against the official CIS benchmark, refer to the [CIS 1.6 Benchmark - Self-Assessment Guide - Rancher v2.5.4](https://rancher.com/docs/rancher/v2.6/en/security/rancher-2.5/1.6-benchmark-2.5/).
